//收缩与伸展(分形频道：fractal.cn)2004
import java.awt.*;
import javax.swing.*;


public class ifs06 extends JApplet implements Runnable {
  ...
  int transX(double x)
  {
    return (int)((double)(x - l) / (r - l) * w/4+200);
  }
  
  int transY(double y)
  {
    return (int)((double)(y - t0) / (b - t0) * w/4+200);
  }
  ...
  public void ifs(Graphics g,float k)
  {
    ...
    map[0][0] =  0.5;   map[1][0] =  -0.5;     map[2][0] =  0.5;   map[3][0] =  0.25;      
    map[0][1] =  0.5;   map[1][1] =  0.5;      map[2][1] =  -0.5;  map[3][1] =  0.25;      
    map[0][2] =  0.0;   map[1][2] =  0.0;      map[2][2] =  0.0;   map[3][2] =  0.0;      
    map[0][3] =  0.0;   map[1][3] =  0.0;      map[2][3] =  0.0;   map[3][3] =  0.0;      
    map[0][4] =  0.0;   map[1][4] =  1.0;      map[2][4] =  0.0;   map[3][4] =  k;      
    map[0][5] =  0.0;   map[1][5] =  0.0;      map[2][5] =  1;     map[3][5] =  k;      
    map[0][6] =  0.2;   map[1][6] =  0.2;      map[2][6] =  0.3;   map[3][6] =  0.3;      
