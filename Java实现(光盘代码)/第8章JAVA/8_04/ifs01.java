//生长出来的sierpinski垫片(分形频道：fractal.cn)2004
import java.awt.*;
import javax.swing.*;

public class ifs01 extends JApplet implements Runnable 
{  
    public int lines = 0;
    public double map[][];
    ...
    int transX(double x)
    {
        return (int)((double)(x - l) / (r - l) * w-200);
    }
  
    int transY(double y)
    {
        return (int)((double)(y - t0) / (b - t0) * h);
    }
    ...
    public void ifs(Graphics g,float k)
    {
        ...
        map[0][0] =  0.5;   map[1][0] =  0.5;   map[2][0] =  k;
        map[0][1] =  0.0;   map[1][1] =  0.0;   map[2][1] =  0.0;
        map[0][2] =  0.0;   map[1][2] =  0.0;   map[2][2] =  0.0;
        map[0][3] =  0.5;   map[1][3] =  k;     map[2][3] =  0.5;
        map[0][4] =  0.0;   map[1][4] =  k;     map[2][4] =  0.25;
        map[0][5] =  0.0;   map[1][5] =  0.0;   map[2][5] =  k;
