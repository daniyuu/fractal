//>变形的芦苇(分形频道：fractal.cn)2004
import java.awt.*;
import javax.swing.*;

public class ifs04 extends JApplet implements Runnable 
{  
    public int lines = 0;
    public double map[][];
    ...
    int transX(double x)
    {
        return (int)((double)(x - l) / (r - l) * w/2-100);
    }
  
    int transY(double y)
    {
        return (int)((double)(y - t0) / (b - t0) * h/2+150);
    }
    ...
    public void paint (Graphics g)
    {
       ...
       {
           D+=10;
           if (D>=1900) dstatus = false;
       } 
       else 
       {
           D -=10;
           if (D<=-1900) dstatus = true;
       }    
       //清除缓冲内的图形
    ...
    public void ifs(Graphics g,float k)
    {
        ...
        map[0][1] =  0.5;   map[1][1] =  0.5;      map[2][1] =  0.5;    
        map[0][2] =  0.0;   map[1][2] =  k;        map[2][2] =  0.0;    
        map[0][3] =  0.0;   map[1][3] =  k;        map[2][3] =  0.0;   
        map[0][4] =  0.0;   map[1][4] =  1.0;      map[2][4] =  0.5;   
        map[0][5] =  0.0;   map[1][5] =  k/1600;   map[2][5] =  0.0;   
        map[0][6] =  0.3;   map[1][6] =  0.3;      map[2][6] =  0.4;   
