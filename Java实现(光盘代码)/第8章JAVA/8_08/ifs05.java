//王冠(分形频道：fractal.cn)2004
import java.awt.*;
import javax.swing.*;


public class ifs05 extends JApplet implements Runnable {
  ...
  public void ifs(Graphics g,float k)
  {
    ...
    map[0][0] =  0.5;   map[1][0] =  0.5;     map[2][0] =  0.25;   map[3][0] =  0.25;      
    map[0][1] =  0.5;   map[1][1] =  0.5;     map[2][1] =  0.25;   map[3][1] =  0.25;      
    map[0][2] =  0.0;   map[1][2] =  0.0;     map[2][2] =  0.0;    map[3][2] =  0.0;      
    map[0][3] =  0.0;   map[1][3] =  0.0;     map[2][3] =  0.0;    map[3][3] =  0.0;      
    map[0][4] =  0.0;   map[1][4] =  0.5;     map[2][4] =  k;      map[3][4] =  1-k;      
    map[0][5] =  0.0;   map[1][5] =  0.0;     map[2][5] =  k;      map[3][5] =  k;      
