...
//绘制sierpinski三角形的类
public class cell01 extends JApplet implements ActionListener
{
     ...
     public void paint(Graphics g)
     {
          ...
          for(int i = 0;i<SIZE - 2;i++)
          {
               for(int j = 0;j<SIZE - 2;j++)
               {
                    ...
                    int nbr = cellarr1[1 + (j - 1) % (SIZE - 2)] +
                    cellarr1[1 + (j + 1) % (SIZE - 2)];
